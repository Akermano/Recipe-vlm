...
## Цель
Разработать приложение, которое по фотографии содержимого холодильника или продуктовой полки распознаёт продукты и предлагает рецепты на их основе.
...
3. На основе найденного списка продуктов языковая модель генерирует от 1 до 10 рецептов.
4. Пользователь может применить фильтры: вегетарианское питание, максимальное время готовки, сложность и количество порций.
5. В интерфейсе можно сравнить ручной список продуктов с ответом модели и экспортировать таблицы и графики.
6. Для оценки качества используется набор из 10 фотографий и файл ручной разметки `eval_expected.csv`.
